...
-- WowWarriorClassState.UpdateFromBitmap. R8 and G1 are reserved (previously
-- CanCastWhirlwind()/CanCastSweepingStrikes() -- removed since nothing ever
-- consumed the decoded WhirlwindCooledDown/SweepingStrikesCooledDown fields
-- on the C# side; re-add here if Whirlwind/Sweeping Strikes gets wired into
-- the actual rotation).
------------------------------------------------------------
